 ...
 */
public class DrawingView_Layers extends DrawingView_Challenge{
    public DrawingView_Layers(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void init(){
        ...
        initial = true;
        paint = new Paint();
        board = new BoardState_Layers(NUM_BLOCKS_ACROSS, NUM_BLOCKS_TALL);
